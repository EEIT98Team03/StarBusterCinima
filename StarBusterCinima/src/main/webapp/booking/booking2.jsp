...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <link rel="stylesheet" href="../css/booking/jquery.multilevelpushmenu.css">
        <link rel="stylesheet" href="../css/booking/basichtml.css">
    ...
    <body>
        ...
        <script src="../js/booking/jquery.multilevelpushmenu.min.js"></script>
        <script type="text/javascript" src="../js/booking/basichtml.js"></script>
    </body>
</html>
