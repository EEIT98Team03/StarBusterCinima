        ...
        <div class="row">
            <div class="col-md-8">
                <section>
                    ...
                    <hr>
                    <form class="form-horizontal" method="post" name="MemberBean" id="signup"  action='<c:url value="/member/register.controller"/>'>
                        <div class="form-group">
                            <label class="control-label col-sm-3">Email ID <span class="text-danger">*</span></label>
                            <div class="col-md-8 col-sm-9">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Enter your Email ID" value="" required>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="name" id="name" placeholder="Enter your Name here" value="" required>
                               </div>
                                 </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5 col-sm-8">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                    <input type="text" class="form-control" name="phoneNumber" id="phoneNumber" placeholder="0987654321" value="" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-8 col-sm-9">
                                <div class="input-group">
                                    <span class="input-group-addon"><i class="glyphicon glyphicon-phone"></i></span>
                                    <input type="text" class="form-control" name="address" id="address" placeholder="Please enter the current place of residence" value="" required>
                               </div>
                                </div>
                        </div>
                        <!--<div class="form-group">
