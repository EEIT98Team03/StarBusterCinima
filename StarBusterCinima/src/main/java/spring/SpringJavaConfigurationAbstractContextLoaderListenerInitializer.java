...
@Configuration
@ComponentScan(basePackages = { "member.model", "gift.model", "booking.model"})
...
//		.setProperty("hibernate.show_sql", "true")
		;
		builder.addAnnotatedClasses(MemberBean.class, GiftItemBean.class, FilmBean.class);//加入要受hibernate管理的Bean
